...
export function Footer() {
  return (
    <section className="bg-black rounded-t-[5rem] text-white pt-[8rem] pb-[4rem] px-[2rem] lg:px-[8rem]">
      <div className="footer-body  grid gap-12 grid-cols-1 min-[600px]:grid-cols-3 min-[1184px]:grid-cols-4 ">
        <div className="col-span-1 sm:col-span-3 lg:col-span-1">
          <div className="logo-section border-b-2 border-gray-500 pb-6 ">
          ...
          <div className="contact-us-section ">
            <h2 className="uppercase my-4">Contact us</h2>
            <div className="">
        ...
        <div className="product flex flex-col">
          <h2 className="uppercase mb-4">Product</h2>
          <div className="flex flex-col gap-4">
            <div className="product-item flex items-center ">
              <div className="w-[5rem] h-[5rem] mr-4 rounded-2xl overflow-hidden">
                <img src={backpack} />
              </div>
              <div className="">
        ...
        <div className="utility-pages-section">
